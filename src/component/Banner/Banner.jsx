      ...
      <Carousel>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h3>Why Vancharam</h3>
            <p>
              Eating Vancharam fish is an important source of omega-3 fatty
              acids. These essential nutrients keep our heart and brain healthy.
              Two omega-3 fatty acids found in fish are EPA (eicosapentaenoic
              acid) and DHA (docosahexaenoic acid). Our bodies don't produce
              omega-3 fatty acids so we must get them through the food we eat.
            </p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
